<template>
	<div id="main">
		<h4 style="margin-top:10px">温馨提示：要进行图片插入的话，请先点击选择图片，然后单击上传，上传成功后即可查看效果</h4>
    	<mavon-editor class="set" v-model="value" @change="getHTML"></mavon-editor>

    	<div class="img-upload">
		    <form id='myform'>
		    	<input class="input-img" type='file' name='myImg' id='myImg'/>
		    	<el-button class="button-img" type="primary" icon="search">选择图片</el-button>   
			...
			<el-button class="sub-article" type="primary" @click="dialogFormVisible = true">存为草稿<i class=" el-icon--right"></i></el-button>
	...
	export default{
		...
		methods: {
		    ...
		    subArticle:function(){
		    	...
		    	this.$store.commit('setblog',this.content)
		    	// this.axios({
